...
* This game could be play vs Computer or Multiplayer.
* For vs Computer, as part of my training, I use `Minimax Algorithm` to make the computer play as smart as the algorithm told to do.
